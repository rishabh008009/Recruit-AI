...
export function SignUpPage({ onSignUp, onSwitchToLogin }: SignUpPageProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-violet-950 via-purple-900 to-indigo-950">
      ...
      <div className="blob w-96 h-96 bg-cyan-500 top-0 right-0" />
      <div className="blob w-80 h-80 bg-purple-500 bottom-0 left-0" style={{ animationDelay: '-2s' }} />
      <div className="blob w-72 h-72 bg-pink-500 top-1/3 left-1/4" style={{ animationDelay: '-4s' }} />
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-white mb-2">
              Join <span className="gradient-text">Recruit AI</span>
            </h1>
            <p className="text-purple-200">Start processing resumes with AI in seconds</p>
          </div>
          ...
          <div className="glass rounded-2xl shadow-glass p-8">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/80 text-neutral-500 rounded-full">or sign up with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start">
                <input
                  id="terms"
                  type="checkbox"
                  className="w-4 h-4 mt-0.5 text-purple-600 border-neutral-300 rounded focus:ring-purple-500"
                  required
                />
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            <div className="glass-dark rounded-xl p-4 text-center card-hover">
              ...
              <div className="text-xs text-purple-200">Resumes Processed</div>
            </div>
            <div className="glass-dark rounded-xl p-4 text-center card-hover">
              <div className="text-2xl font-bold text-white">28hrs</div>
